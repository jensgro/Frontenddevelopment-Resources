...
-	[dpi love](http://dpi.lv/) - get the dpi (ppi) calculated out of the monitor's dimensions
-	[Responsive Navigation](http://responsivenavigation.net/) extensive examples of responsive navigations
-	[Media Query & Asset Downloading](http://timkadlec.com/2012/04/media-query-asset-downloading-results/)
...
### HTML5-Rocks in a short series

-	[The Basics](http://www.html5rocks.com/en/tutorials/webcomponents/shadowdom/)
-	[The Styling](http://www.html5rocks.com/en/tutorials/webcomponents/shadowdom-201/)
-	[Advanced Concepts and DOM APIs](http://www.html5rocks.com/en/tutorials/webcomponents/shadowdom-301/)
...
-	[Learning jQuery with Street Fighter and Hadoukens](http://www.thinkful.com/learn/intro-to-jquery) - an interactive intro into jQuery
...
-	[CSSTriggers](http://csstriggers.com/) - Reference about which effect on performance the changing of various CSS properties has.
